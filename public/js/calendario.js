class Calendar {
    constructor(id) {
        ...
        this.showTemplate();
        this.elGridBody = this.elCalendar.querySelector('.cuerpo_cuerpo');
    ...
    getTemplate() {
        let template = `
            <div class="calendario_cabeza">
                <button type="button" class="control control--prev">    &lArr; </button>
                <span class="nombre-mes">dic 2019</span>
                <button type="button" class="control control--next">    &rArr; </button>
            </div>
            <div class="calendario_cuerpo">
                <div class="cuerpo">
                    <div class="cuerpo_cabeza">
